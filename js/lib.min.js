! function(e, t) {
  ...
  function F(e, t, n) {
    var r, i = 0,
      ...
      s = function() {
        for (var t = Ut || D(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, i = 1 - r, o = 0, s = l.tweens.length; o < s; o++) l.tweens[o].run(i);
  ...
  K.fn = K.prototype = {
    ...
    makeArray: function(e, t) {
      var n, r = t || [];
      return null != e && (n = K.type(e), null == e.length || "string" === n || "function" === n || "regexp" === n || K.isWindow(e) ? V.call(r, e) : K.merge(r, e)), r
    },
  ...
  K.fn.extend({
    ...
    removeAttr: function(e, t) {
      var n, r, i, o, a = 0;
      if (t && 1 === e.nodeType)
        for (r = t.split(te); a < r.length; a++) i = r[a], i && (n = K.propFix[i] || i, o = ke.test(i), o || K.attr(e, i, ""), e.removeAttribute(Ee ? i : n), o && n in e && (e[n] = !1))
    },
    attrHooks: {
      type: {
        set: function(e, t) {
  ...
  K.event = {
      ...
      }, Le.test(t) && (K.event.fixHooks[t] = K.event.keyHooks), De.test(t) && (K.event.fixHooks[t] = K.event.mouseHooks)
    }),
    function(e, t) {
      function n(e, t, n, r) {
        n = n || [], t = t || D;
      ...
      function s(e, t) {
        ...
        for (s = e, l = [], u = b.preFilter; s;) {
          r && !(i = Z.exec(s)) || (i && (s = s.slice(i[0].length) || s), l.push(o = [])), r = !1, (i = ee.exec(s)) && (o.push(r = new L(i.shift())), s = s.slice(r.length), r.type = i[0].replace(G, " "));
          for (a in b.filter) !(i = se[a].exec(s)) || u[a] && !(i = u[a](i)) || (o.push(r = new L(i.shift())), s = s.slice(r.length), r.type = a, r.matches = i);
          if (!r) break
        }
      ...
      var y, v, b, x, w, T, N, C, k, E, S = !0,
        ...
        de = le(function(e) {
          ...
          return v = !D.getElementById(j), H.removeChild(e), t
        });
      try {
  ...
  Ze.optgroup = Ze.option, Ze.tbody = Ze.tfoot = Ze.colgroup = Ze.caption = Ze.thead, Ze.th = Ze.td, K.support.htmlSerialize || (Ze._default = [1, "X<div>", "</div>"]), K.fn.extend({
      ...
      html: function(e) {
        return K.access(this, function(e) {
          ...
          if ("string" == typeof e && !Ve.test(e) && (K.support.htmlSerialize || !Ye.test(e)) && (K.support.leadingWhitespace || !Re.test(e)) && !Ze[(Ie.exec(e) || ["", ""])[1].toLowerCase()]) {
            e = e.replace($e, "<$1></$2>");
            try {
      ...
      domManip: function(e, n, r) {
        ...
        var i, o, a, s, l = 0,
          ...
          c = [],
          p = this.length;
        if (!K.support.checkClone && p > 1 && "string" == typeof u && Qe.test(u)) return this.each(function() {
      ...
      var i, o, a, s = e[0];
      return n = n || R, n = !n.nodeType && n[0] || n, n = n.ownerDocument || n, !(1 === e.length && "string" == typeof s && s.length < 512 && n === R && "<" === s.charAt(0)) || Ue.test(s) || !K.support.checkClone && Qe.test(s) || !K.support.html5Clone && Ye.test(s) || (o = !0, i = K.fragments[s], a = i !== t), i || (i = n.createDocumentFragment(), K.clean(e, n, i, r), o && (K.fragments[s] = a && i)), {
        fragment: i,
        cacheable: o
      }
    }, K.fragments = {}, K.each({
      ...
      clone: function(e, t, n) {
        var r, i, o, a;
        if (K.support.html5Clone || K.isXMLDoc(e) || !Ye.test("<" + e.nodeName + ">") ? a = e.cloneNode(!0) : (tt.innerHTML = e.outerHTML, tt.removeChild(a = tt.firstChild)), !(K.support.noCloneEvent && K.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || K.isXMLDoc(e)))
          ...
          if ("number" == typeof a && (a += ""), a) {
            if ("string" == typeof a)
              if (Xe.test(a)) {
                ...
                if (!K.support.tbody)
                  for (p = ze.test(a), d = "table" !== s || p ? "<table>" !== l[1] || p ? [] : f.childNodes : f.firstChild && f.firstChild.childNodes, o = d.length - 1; o >= 0; --o) K.nodeName(d[o], "tbody") && !d[o].childNodes.length && d[o].parentNode.removeChild(d[o]);
  ...
  Ct = Mt.exec(kt.toLowerCase()) || [], K.fn.load = function(e, n, r) {
    ...
    ajax: function(e, n) {
      ...
      if (g.promise(T), T.success = T.done, T.error = T.fail, T.complete = m.add, T.statusCode = function(e) {
          ...
          return this
        }, p.url = ((e || p.url) + "").replace(Et, "").replace(Lt, Ct[1] + "//"), p.dataTypes = K.trim(p.dataType || "*").toLowerCase().split(te), null == p.crossDomain && (u = Mt.exec(p.url.toLowerCase()), p.crossDomain = !(!u || u[1] === Ct[1] && u[2] === Ct[2] && (u[3] || ("http:" === u[1] ? 80 : 443)) == (Ct[3] || ("http:" === Ct[1] ? 80 : 443)))), p.data && p.processData && "string" != typeof p.data && (p.data = K.param(p.data, p.traditional)), k(_t, p, n, T), 2 === x) return T;
      if (c = p.global, p.type = p.type.toUpperCase(), p.hasContent = !jt.test(p.type), c && 0 === K.active++ && K.event.trigger("ajaxStart"), !p.hasContent && (p.data && (p.url += (Dt.test(p.url) ? "&" : "?") + p.data, delete p.data), i = p.url, p.cache === !1)) {
        var N = K.now(),
            ...
            l.send(n.hasContent && n.data || null), r = function(e, i) {
              ...
              try {
                if (r && (i || 4 === l.readyState))
                  if (r = t, a && (l.onreadystatechange = K.noop, Xt && delete zt[a]), i) 4 !== l.readyState && l.abort();
                  else {
              ...
              f && o(s, u, f, c)
            }, n.async ? 4 === l.readyState ? setTimeout(r, 0) : (a = ++Vt, Xt && (zt || (zt = {}, K(e).unload(Xt)), zt[a] = r), l.onreadystatechange = r) : r()
          },
          abort: function() {
            r && r(0, 1)
          }
  ...
  K.Animation = K.extend(F, {
    ...
    stop: function(e, n, r) {
      ...
      return "string" != typeof e && (r = n, n = e, e = t), n && e !== !1 && this.queue(e || "fx", []), this.each(function() {
        ...
        if (n) a[n] && a[n].stop && i(a[n]);
          ...
          for (n in a) a[n] && a[n].stop && Gt.test(n) && i(a[n]);
    ...
    var e, n = K.timers,
      r = 0;
    for (Ut = K.now(); r < n.length; r++) e = n[r], !e() && n[r] === e && n.splice(r--, 1);
    n.length || K.fx.stop(), Ut = t
...
function(e) {
  ...
  e(document).ready(function() {
    var t, n = e("nav"),
      r = n.find(".nav-title a"),
      i = n.find("ul"),
      o = e("html").hasClass("no-touch"),
      a = e(window),
      s = function() {
        clearTimeout(t), t = setTimeout(l, 50)
      },
      l = function() {
        e(window).width() > 1035 ? i.show() : o || (i.hide(), r.removeClass("active-tab"))
      };
    r.on("click", function(t) {
      return !(a.width() > 1035) && (e(this).hasClass("active-tab") ? (e(this).removeClass("active-tab"), e(e(this).attr("href")).hide()) : (i.hide(), r.removeClass("active-tab"), e(this).addClass("active-tab"), e(e(this).attr("href")).show()), void t.preventDefault())
    }), e(window).on("resize", s), e(".video").fitVids()
  })
}(window.jQuery);